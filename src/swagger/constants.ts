...
export const SWAGGER_PROVIDER_API_DESCRIPTION = `
  ...
  <a href="http://13.124.198.164:3000/connect?userKey=34634&providerId=PVD3344718234">http://13.124.198.164:3000/connect?userKey={userKey}&providerId={providerId}</a>
  `;
